namespace CupcakeYPasteles.Migrations
{
    ...
    public partial class mgasn : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        productofk = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.Productoes", t => t.productofk, cascadeDelete: true)
                .Index(t => t.productofk);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Ingresoes", "productofk", "dbo.Productoes");
            ...
            DropIndex("dbo.Ingresoes", new[] { "productofk" });
